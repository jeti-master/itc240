...
if(isset($_POST['name'])) {
  ...
  echo '
    <p>' . $_POST['name'] . ', your blog request has been sent successfully!</p>
          ...
          <form name="sentMessage" id="contactForm" action="" method="post" novalidate>
            ...
            <div class="control-group">
              <div class="form-group floating-label-form-group controls">
                ...
                Tech <input type="radio" name="about" value="tech" class="form-control"> <br>
                Programming <input type="radio" name="about" value="programming" class="form-control"> <br>
                <p class="help-block text-danger"></p>
              </div>
            </div>
            <div class="control-group">
              <div class="form-group floating-label-form-group controls">
                <label>Blog Includes</label>
