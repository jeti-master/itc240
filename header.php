...
<html lang="en">
  ...
  <head>
    ...
    <title>codeBlog - Adventures in code</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand" href="index.php">Bootstrap This</a>
    ...
    <!-- Page Header -->
    <header class="masthead" style="background-image: url('img/code.png')">
